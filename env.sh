...
export PLUGIN_CLIENT_CERT="$(cat ${BASE_PATH}/certs/${PLUGIN_CLIENT_ALGO}-mtls-client.crt)"
export PLUGIN_CLIENT_KEY="$(cat ${BASE_PATH}/certs/${PLUGIN_CLIENT_ALGO}-mtls-client.key)"

export PLUGIN_SERVER_CERT="$(cat ./certs/${PLUGIN_SERVER_ALGO}-mtls-server.crt)"
export PLUGIN_SERVER_KEY="$(cat ./certs/${PLUGIN_SERVER_ALGO}-mtls-server.key)"
