...
LANGUAGES[python]="Python:python:true:python3 python/example-py-client.py:gRPC/BoringSSL:yes"
LANGUAGES[ruby]="Ruby:ruby:true:ruby ruby/rb-kv-client.rb:gRPC/BoringSSL:yes"
LANGUAGES[nodejs]="Node.js:nodejs:npm install:node client.js:OpenSSL:no"
