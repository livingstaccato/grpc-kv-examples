...
LANGUAGES[java]='Java|java|gradle build|gradle runClient|Netty/JDK|no'
...
LANGUAGES[cpp]='C++|cpp|./build.sh|export LD_LIBRARY_PATH=${BUILD_DIR:-$PWD/build/patched-grpc}/install/lib:${LD_LIBRARY_PATH:-} GRPC_SSL_CIPHER_SUITES=ECDHE-ECDSA-AES256-GCM-SHA384:ECDHE-ECDSA-AES128-GCM-SHA256:ECDHE-ECDSA-CHACHA20-POLY1305 && ./build/kv-client|gRPC/BoringSSL|yes'
